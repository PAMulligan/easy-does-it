...
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./main.css */ "./src/blocks/edi-logo/main.css");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)('easy-does-it-blocks/edi-logo', {
  icon: {
  ...
  edit({
    ...
    const selectImg = img => {
      ...
      if ((0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_5__.isBlobURL)(img.url)) {
        ...
        newImgURL = img.sizes ? img.sizes.thumbnail.url : img.media_details.sizes.thumbnail.source_url;
        setAttributes({
          imgID: img.id,
          imgAlt: img.alt,
          imgURL: newImgURL
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, imgPreview && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.BlockControls, {
      group: "inline"
      ...
      name: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Replace Image", "easy-does-it-blocks"),
      mediaId: imgID,
      mediaURL: imgURL,
      allowedTypes: ["image"],
      accept: "image/*",
    ...
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Remove Image", "easy-does-it-blocks"))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Settings", "easy-does-it-blocks")
    }, imgPreview && !(0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_5__.isBlobURL)(imgPreview) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.TextareaControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Alt Attribute", "easy-does-it-blocks"),
      value: imgAlt,
      onChange: imgAlt => setAttributes({
        imgAlt
      }),
      help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Description of your image for screen readers.", "easy-does-it-blocks")
  ...
  save({
    ...
    const imageClass = `wp-image-${imgID}`;
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, imgURL && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
      src: imgURL,
      alt: imgAlt,
      className: imageClass
    }));
